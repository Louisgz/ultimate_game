...
<body class="body-bg">
    ...
    <div class="battle-main-perso">
        <img src="./images/<? echo $player->getType(); ?>.png" class="battle-player-image" alt="perso <?php echo $player->getType() ?>">
        ...
        ?>
                <div class="battle-perso-row">
                    <div class="battle-perso-image-container">
                        <img src="./images/<? echo $perso->getType(); ?>.png" class="battle-perso-image" alt="perso <?php echo $perso->getType() ?>">
                    </div>
