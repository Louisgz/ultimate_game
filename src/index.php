        ...
        <div class="persos-list">
            ...
            foreach ($ALL_PERSOS as $row) {
                ...
                <div class="perso-container">
                    <div class="perso-delete"
                         onclick="document.location = './delete_perso.php?id=<?php echo $row['id']; ?>'">X
                    </div>
        ...
        <form action="create_perso.php" method="post">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" aria-label="Text input with dropdown button"
                       placeholder="Le nom de ton personnage" name="perso">
            </div>
            <div class="input-group mb-3 images-container">
                <div class="form-check select-perso">
                    <img src="./images/magicien.png" class="perso-image" alt="perso magicien"
                         onclick="document.querySelector('#input-type-1').checked = true">
                    <label class="form-check-label" for="exampleRadios1">
                        Magicien
                    </label>
                    <input class="form-check-input" id="input-type-1" type="radio" name="type" id="exampleRadios1"
                           value="magicien" checked>
                </div>
                <div class="form-check select-perso">
                    <img src="./images/guerrier.png" class="perso-image" alt="perso guerrier"
                         onclick="document.querySelector('#input-type-2').checked = true">
                    <label class="form-check-label" for="exampleRadios2">
                        Guerrier
                    </label>
                    <input class="form-check-input" id="input-type-2" type="radio" name="type" id="exampleRadios2"
                           value="guerrier">
                </div>
            </div>
            <div class="input-group mb-3">
